...
<div class="col-md-2 col-md-offset-5">
  <article class="boardArticle">
    ...
    <?php
      if(isset($bNo)) {
        $sql = 'select count(bbs_no) as cnt from reviewBoard where bbs_no = ' . $bNo;
    ...
    <?php
      exit;
        ...
        $sql = 'select bbs_title from reviewBoard where bbs_no = ' . $bNo;
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
    ?>
    <div id="boardDelete">
        ...
        <table>
          ...
          <tbody>
            ...
            if(isset($_SESSION['is_login']) && isset($_SESSION['id'])) {
              ?>
                <input type="hidden" name="bPassword" id="bPassword" value="<?php echo $id ?>">
