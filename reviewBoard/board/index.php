...
<br/><br/><br/><br/>
  ...
  <div class="col-md-8 col-md-offset-2">
    <article class="boardArticle">
      <!-- <h3>자유게시판</h3> -->
      <div id="boardList">
        <table class="table table-hover" width="100%" style="height: 15px; margin: auto; text-align: center;">
          <!-- <caption class="readHide">자유게시판</caption> -->
          <thead>
            <tr class="tr">
              <th scope="col" class="no" style="text-align: center;">번호</th>
              <th scope="col" class="title" style="text-align: center;">제목</th>
              <th scope="col" class="author" style="text-align: center;">작성자</th>
              <th scope="col" class="date" style="text-align: center;">작성일</th>
              <th scope="col" class="hit" style="text-align: center;">조회수</th>
            </tr>
          </thead>
          <tbody>
              <?php
