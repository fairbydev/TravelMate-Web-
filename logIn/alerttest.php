    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="../freeboard/freebbs.php">FREE BOARD</a></li>
          <li><a href="logIn.php">로그인</a></li>
          <li><a href="../signIn/signInInput.html">회원가입</a></li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row">
          <div class="col-md-12">
              <div class="wrap">
                  <br/><br/><br/><br/>
                  <!-- 아이디 비번 입력 폼 -->
                  <form class="login" role="form" id="form" method="post" action="alerttest.php">
                  <!-- <form class="login" role="form" method="post" action="logInCheck.php">                     -->
...
<footer class="container-fluid text-center">
  <p class="text-center footer-text">
      ...
      <small>대표 : 박재홍 ㆍ 주소 :  남성역 3번출구 ㆍ 전화 : 010-0000-0000</small><br>
