  ...
  <div class="jumbotron text-center">
    ...
    <form role="form" id="form" method="get" action="travelList.php">
      <div>
        ...
        <select class="selectpicker show-tick show-menu-arrow" data-container="body" name="areaSelect" id="areaSelect" data-width="auto">
          <option>-전체-</option>
          <option>서울</option>
          <option>경기도</option>
          <option>충청도</option>
                  ...
                  <div class="column">
                    ...
                    <div class="post-module">
                      ...
                      <div class="thumbnail">
                        ...
                        <img src="../images/communication.jpg" class="img-responsive" alt=""> </div>
                      <!-- Post Content-->
                      <div class="post-content">
                        <div class="category">경기도</div>
                        <h1 class="title">당일치기 남이섬 여행</h1>
                        <h2 class="sub_title">아름다운 남이섬과 닭갈비까지 1석2조!</h2>
                        <p class="description">안녕하세요. 날씨가 너무 아름다운 4월을 맞아 남이섬 여행을 계획하고 있는데 관심있는 분들의 많은 참여 바랍니다.</p>
                  ...
                  <div class="column">
                    ...
                    <div class="post-module">
                      ...
                      <div class="thumbnail">
                        ...
                        <img src="../images/enhancement.jpg" class="img-responsive" alt="noIMG"> </div>
                      <!-- Post Content-->
                      <div class="post-content">
                        <div class="category">경기도</div>
                        <h1 class="title">광덕산의 한 컷을 담다</h1>
                        <h2 class="sub_title">등산과 함꼐 사진 속 추억까지</h2>
                        <p class="description">해당 모임은 전문장비가 필요하지는 않으나 등산을 위한 개인준비가 꼭 필요합니다.</p>
                        <div class="post-meta"><span class="timestamp"><i class="fa fa-clock-">o</i> 6 mins ago</span><span class="comments"><i class="fa fa-comments"></i><a href="#"> 39 comments</a></span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="column">
                    ...
                    <div class="post-module">
                      ...
                      <div class="thumbnail">
                        ...
                        <img src="../images/friends2.jpg" class="img-responsive" alt=""> </div>
                      <!-- Post Content-->
                      <div class="post-content">
                        <div class="category">경기도</div>
